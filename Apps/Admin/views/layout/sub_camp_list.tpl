...
目的地：{@form_select onchange='this.form.submit();' name="destination" model=$schmodel@}&nbsp;&nbsp;
...
<td><a href="/cncamp-{@$rs.id@}.html" target="_blank">{@$rs.title@}</a></td>
<!-- <td align="center">{@$rs.theme|smval:'@pf_theme'@}</td> -->
<td align="center">{@$rs.destination|smval:'@pf_destination'@}</td>
...
<td align="right">
<a dialog="1" class="samao-link-minibtn" href="__APPROOT__/cdep_date?campid={@$rs.id@}">出发日期</a>
<a dialog="1" class="samao-link-minibtn" href="__APPROOT__/schedule?campid={@$rs.id@}&pid=1">日程安排</a>
