...
<link rel="stylesheet" href="__PUBLIC__/css/home/collection.css">
            ...
            <div class="order_content">
                ...
                <ul class="order_lists">
                    <li class="list_con">
                        ...
                        <div class="list_text"><a href="/paper/index.html?id={@$paper.id@}" target="_back"> {@$paper.title@}</a></div>
                    </li>
                    <li class="list_info">
                        <p>{@$paper.abstract@}</p>
                    </li>
                    <li class="list_price">
                        <p class="price">{@$paper.authors@}</p>
                    </li>
                    ...
                    <li class="list_op">
                        <p class="del"><a href="javascript:;" class="delBtn">移除</a><input type="hidden" value="{@$paper.id@}"></p>
                    </li>
                </ul>
                {@/foreach@}
            </div>
