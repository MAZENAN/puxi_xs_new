...
// 
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Core/OssUtil.php';
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Core/OssException.php';
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Core/MimeTypes.php';
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Http/RequestCore.php';
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Http/ResponseCore.php';
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Http/RequestCore_Exception.php';
 require_once ROOT_DIR . 'libs/aliyun/src/Oss/Result/PutSetDeleteResult.php';
